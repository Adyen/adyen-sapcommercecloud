...
public class CancellationNotificationEventListenerTest {
    ...
    @InjectMocks
    private CancellationNotificationEventListener cancellationNotificationEventListener;
    ...
    public void testOnEvent() {
        ...
        adyenNotificationModel.setEventCode(EVENT_CODE_CANCELLATION);
        ...
        CancellationEvent cancellationEvent = new CancellationEvent(adyenNotificationModel);

        cancellationNotificationEventListener.onEvent(cancellationEvent);
