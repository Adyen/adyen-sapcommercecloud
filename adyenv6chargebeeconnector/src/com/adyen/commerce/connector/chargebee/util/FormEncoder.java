 ...
 * params (e.g. {@code subscription_items[item_price_id][0]}), which are passed through as literal keys.
 * Null values are skipped, and iteration order follows the supplied map.
 */
