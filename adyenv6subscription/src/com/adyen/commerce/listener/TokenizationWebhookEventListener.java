package com.adyen.commerce.listener;
...
public class TokenizationWebhookEventListener extends AbstractEventListener<TokenizationEvent> {
    ...
    protected static String TOKEN_ALREADY_EXISTS = "recurring.token.alreadyExisting";
    ...
    protected void onEvent(TokenizationEvent tokenizationEvent) {
        ...
        if (TOKEN_CREATED.equals(data.getEventType()) || TOKEN_ALREADY_EXISTS.equals(data.getEventType())) {
